...
<head>
    ...
    <title>Portifolio Gilson Junior | Android Developer</title>
        ...
        <div class="col-12">
            ...
            <nav>
                <ul id="nav">
                    ...
                    <li class="page_item page-item-2 current_page_item"><a href="references.php">references</a></li>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <ul id="thumbs" class="thumbs clearfix">
                    <li style="opacity: 1;">
                        <a href="https://www.linkedin.com/in/alexandre-pereira-b62a8829/">
                            <img src="resources/images/ref_alexandre.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="feature-qantas-homepage" srcset="resources/images/ref_alexandre.png 628w, resources/images/ref_alexandre.png 300w" sizes="(max-width: 628px) 100vw, 628px">						            <div class="description">
                    ...
                    <li style="opacity: 1;">
                        <a href="https://www.linkedin.com/in/debora-ruedell-514b6950/">
                            <img src="resources/images/ref_debora.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="feature-qantas-homepage" srcset="resources/images/ref_debora.png 628w, resources/images/ref_debora.png 300w" sizes="(max-width: 628px) 100vw, 628px">						            <div class="description">
                                <span class="arrow-r"></span>
                            </div>
                        </a>
                    </li>
                    ...
                    <li style="opacity: 1;">
                        <a href="https://www.linkedin.com/in/douglas-marques-54080b24/">
                            <img src="resources/images/ref_douglas.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="feature-rethinking-flight-search" srcset="resources/images/ref_douglas.png 628w, resources/images/ref_douglas.png 300w" sizes="(max-width: 628px) 100vw, 628px">						            <div class="description">
                                <span class="arrow-r"></span>
                            </div>
                        </a>
                    </li>
                    ...
                    <li style="opacity: 1;">
                        <a href="https://www.linkedin.com/in/jan-antonio-pereira-11994835/">
                            <img src="resources/images/ref_jan.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="feature-growth-giant-brand" srcset="resources/images/ref_jan.png 628w, resources/images/ref_jan.png 300w" sizes="(max-width: 628px) 100vw, 628px">								            <div class="description">
                                <span class="arrow-r"></span>
                            </div>
                        </a>
                    </li>
                    ...
                    <li style="opacity: 1;">
                        <a href="https://www.linkedin.com/in/jurandir-goncalves/">
                            <img src="resources/images/ref_jurandir.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="feature-subscriber-notifications" srcset="resources/images/ref_jurandir.png 628w, resources/images/ref_jurandir.png 300w" sizes="(max-width: 628px) 100vw, 628px">						            <div class="description">
                                <span class="arrow-r"></span>
                            </div>
                        </a>
                    </li>
                    ...
                    <li style="opacity: 1;">
                        <a href="https://www.linkedin.com/in/rafaeldeandradesousa/">
                            <img src="resources/images/ref_rafael.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="feature-quest-research" srcset="resources/images/ref_rafael.png 628w, resources/images/ref_rafael.png 300w" sizes="(max-width: 628px) 100vw, 628px">						            <div class="description">
                                <span class="arrow-r"></span>
                            </div>
                        </a>
                    </li>
